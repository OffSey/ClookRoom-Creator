...
function showExistingCloakrooms()
    if Config.Framework == "ESX" then
        ESX.TriggerServerCallback('admin:getCloakrooms', function(cloakrooms)
            handleCloakrooms(cloakrooms)
        end)
    elseif Config.Framework == "Qb" then
        QBCore.Functions.TriggerCallback('admin:getCloakrooms', function(cloakrooms)
            handleCloakrooms(cloakrooms)
        end)
    end
end

function handleCloakrooms(cloakrooms)
    local options = {}
...
function loadCloakrooms()
    local callbackFunction = function(cloakrooms)
        cloakroomMarkers = cloakrooms
    end

    if Config.Framework == "ESX" then
        ESX.TriggerServerCallback('admin:getCloakrooms', callbackFunction)
    elseif Config.Framework == "Qb" then
        QBCore.Functions.TriggerCallback('admin:getCloakrooms', callbackFunction)
    end
end
